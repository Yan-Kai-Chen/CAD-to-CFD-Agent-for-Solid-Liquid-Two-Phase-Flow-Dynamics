"""Runnable MCP server entry point for safe Siemens NX tools."""
...
from .instructions import NX_MCP_INSTRUCTIONS
from .tools import DISABLED_TOOLS, MCP_TOOL_FUNCTIONS, tool_inventory


SERVER_NAME = "fromcad2cfd-nx"
...
def server_descriptor() -> dict[str, Any]:
    ...
    return {
        ...
        "instructions_summary": "Safe Siemens NX tools only; no arbitrary Python, raw NXOpen, arbitrary journal replay, delete, or overwrite tools.",
    }
...
def build_server() -> Any:
    ...
    server = FastMCP(
        SERVER_NAME,
        instructions=NX_MCP_INSTRUCTIONS,
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="fromcad2cfd-nx-mcp")
