...
Expose only high-level Fluent Solver planning tools.
...
advisory PyFluent templates, and validates resume plans. It must not upload or
package private CAD, mesh, `.msh.h5`, `.cas.h5`, `.dat.h5`, license, or local
ANSYS installation files.
