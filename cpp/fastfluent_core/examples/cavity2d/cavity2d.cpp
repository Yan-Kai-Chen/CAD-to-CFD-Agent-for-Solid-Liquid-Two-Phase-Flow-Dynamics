...
int main(int argc, char* argv[]) {
  ...
  vtmo::vtmWriter<T, LatSet::d> NSWriter("cavity2d", Geo);
  ...
  Printer::Endl();
  WriteFastFluentNativeSummary("cavity2d", MainLoopTimer(), MaxStep, OutputStep, res,
                               Ni, Nj, Cell_Len, rho_ref, Kine_Visc, U_Max,
                               BaseConv.getPhysTime(MainLoopTimer()), "cavity2d");
