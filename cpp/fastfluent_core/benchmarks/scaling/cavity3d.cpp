...
int main(int argc, char* argv[]) {
  ...
  // BlockGeometryHelper3D<T> GeoHelper(Ni, Nj, Nk, cavity, Cell_Len, BlockCellLen, 1, 0, false);
  // GeoHelper.Optimize(mpi().getSize());
  ...
  // Printer::Print_BigBanner(std::string("Start Benchmark..."));
